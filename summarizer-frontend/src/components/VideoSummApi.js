...
class VideoSummApi extends React.Component {
  ...
  <p>
	...
	handleSubmit = async (event) => {
		...
		var FinalURL = `http://127.0.0.1:5000/api/video?=file_name=${this.state.selectedFile.name}`;
			...
			return (
				<>
					<form onSubmit={this.handleSubmit} method='post'>
						...
						<input className="input-1" type="file" accept="video/mp4,video/x-m4v,video/*" value={this.state.value} placeholder="Upload your file here.." name="name" onChange={this.handleChange} required autoComplete="off" />
